...
def fill_data(file_name):
    ...
    if file_name == 'tokens':
        ...
        text = "📍Доброго вечора {user_name}, ми з України ;)\n" \
        ...
        net_list = []
        text_акции = 'Нажаль зараз акцій немає, так як ми донатимо 10% від кожного чеку на ЗСУ. ' \
                     'Переможемо разом 💪 Ти можешь нас підтримати своїм візитом, а також оцінкою в гугл мапах 🙏'
        ...
        d = {'Название': "📍 Mr.White 1 (Русанівка)",
             ...
             'Пароль': 'Пароль: 88888888\nP.S. Це вісім вісімок, тільки нікому не кажи 🤫',
             'Акции': text_акции
            }
        net_list.append(d)
        ...
        d = {'Название': "📍 Mr.White 2 (Лівобережна)",
             ...
             'Пароль': '“24081991” це день набуття Україною незалежності якщо що.',
             'Акции': text_акции}
        net_list.append(d)
...
def create_json(file_name):
    full_path = fR"Data\{file_name}.json"
    print(full_path)
    with open(full_path, mode='wt', encoding='utf-8') as f:
